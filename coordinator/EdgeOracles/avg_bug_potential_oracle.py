...
class AvgBugPotentialOracle:
    ...
    def get_oracle_config(self):
        ...
        try:
            ...
            utils.error_msg("bbl_dom_map|pair_edge files not found in %s"%self.target_dir)
            sys.exit(-1)
        self.bug_edge_file = None 
        try:
    ...
    def get_result(self, raw_data, max_results, covered_seeds):
        ...
        # for i in seeds:
        #     print i, "size: ",os.path.getsize(i), "path length:", self.get_path_length(i)
